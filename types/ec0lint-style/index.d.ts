declare module 'ec0lint-style' {
	...
	namespace ec0lintStyle {
		...
		export type PostcssResult = (PostCSS.Result | EmptyResult) & {
			ec0lintStyle: StylelintPostcssResult;
		...
		export type PublicApi = PostCSS.PluginCreator<PostcssPluginOptions> & {
			...
			) => Promise<ec0lintStyle.Config | undefined>;
			utils: {
				/**
				 * Report a problem.
				 *
	...
	const ec0lintStyle: ec0lintStyle.PublicApi;
