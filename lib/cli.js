...
const meowOptions = {
	...
	autoVersion: false,
	help: `
    Usage: ec0lint-css [input] [options]
    ...
    Options:
      ...
      --config
        ...
        argument is provided, ec0lint-css will search for configuration files in
        the following places, in this order:
          - a ec0lint-css property in package.json
          - a .ec0lintcssrc file (with or without filename extension:
            .json, .yaml, .yml, and .js are available)
          - a ec0lint-css.config.js file exporting a JS object
      ...
      --ignore-path, -i
        ...
        path can be absolute or relative to process.cwd(). By default, ec0lint-css
        looks for .ec0lintcssignore in process.cwd().

      --ignore-pattern, --ip

        Pattern of files to ignore (in addition to those in .ec0lintcssignore)
      ...
      --ignore-disables, --id
        ...
        Ignore ec0lint-css-disable comments.
      ...
      --cache                       [default: false]
        ...
        changed ones the next time you run ec0lint-css. By default, the cache
        is stored in "./.ec0lintcsscache". To adjust this, use --cache-location.

      --cache-location              [default: '.ec0lintcsscache']

        Path to a file or directory to be used for the cache location.
        Default is "./.ec0lintcsscache". If a directory is specified, a cache
      ...
      --report-needless-disables, --rd
        ...
        Also report errors for ec0lint-css-disable comments that are not blocking a lint warning.
        The process will exit with code ${EXIT_CODE_ERROR} if needless disables are found.

      --report-invalid-scope-disables, --risd

        Report ec0lint-css-disable comments that used for rules that don't exist within the configuration object.
        The process will exit with code ${EXIT_CODE_ERROR} if invalid scope disables are found.

      --report-descriptionless-disables, --rdd

        Report ec0lint-css-disable comments without a description.
      ...
      --version, -v
        ...
        Show the currently installed version of ec0lint-css.
