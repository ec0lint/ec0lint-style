...
/** @typedef {import('ec0lint-style').LintResult} LintResult */
/** @typedef {import('ec0lint-style').Warning} Warning */
...
function ruleMetadata(results) {
	...
	return (
		(firstResult &&
			...
			firstResult._postcssResult.ec0lintStyle &&
			firstResult._postcssResult.ec0lintStyle.ruleMetadata) ||
		{}
	);
}
