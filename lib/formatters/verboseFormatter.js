...
/** @typedef {import('ec0lint-css').LintResult} LintResult */
/** @typedef {import('ec0lint-css').Warning} Warning */
...
function ruleMetadata(results) {
	...
	return (
		(firstResult &&
			...
			firstResult._postcssResult.ec0lintCss &&
			firstResult._postcssResult.ec0lintCss.ruleMetadata) ||
		{}
	);
}
