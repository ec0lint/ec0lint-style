...
/** @typedef {import('ec0lint-style').RuleOptions} RuleOptions */
/** @typedef {import('ec0lint-style').RuleOptionsPossible} Possible */
/** @typedef {import('ec0lint-style').RuleOptionsPossibleFunc} PossibleFunc */
 ...
 *
 * @param {import('ec0lint-style').PostcssResult} result - postcss result
...
module.exports = /** @type {typeof import('ec0lint-style').utils.validateOptions} */ (
	validateOptions
);
