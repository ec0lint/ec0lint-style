...
/** @typedef {import('ec0lint-css').RuleOptions} RuleOptions */
/** @typedef {import('ec0lint-css').RuleOptionsPossible} Possible */
/** @typedef {import('ec0lint-css').RuleOptionsPossibleFunc} PossibleFunc */
 ...
 *
 * @param {import('ec0lint-css').PostcssResult} result - postcss result
...
module.exports = /** @type {typeof import('ec0lint-css').utils.validateOptions} */ (
	validateOptions
);
