...
/**
 * Return the cacheFile to be used by ec0lint-style, based on whether the provided parameter is
...
module.exports = function getCacheFile(cacheFile, cwd) {
	...
	function getCacheFileForDirectory() {
		return path.join(resolvedCacheFile, `.ec0lintStylecache_${hash(cwd)}`);
	}
