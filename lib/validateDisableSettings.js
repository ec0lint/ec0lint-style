 ...
 * @typedef {import('ec0lint-css').DisableOptions} DisableOptions
 * @typedef {import('ec0lint-css').DisablePropertyName} DisablePropertyName
...
module.exports = function (result, field) {
	...
	const stylelintResult = result.ec0lintCss;
