 ...
 * @typedef {import('ec0lint-style').DisableOptions} DisableOptions
 * @typedef {import('ec0lint-style').DisablePropertyName} DisablePropertyName
...
module.exports = function (result, field) {
	...
	const stylelintResult = result.ec0lintStyle;
