...
/** @typedef {import('ec0lint-css').DisableReportRange} DisableReportRange */

/**
 * @param {import('ec0lint-css').LintResult[]} results
 */
...
/**
 * @param {import('ec0lint-css').DisabledWarning} warning
